...
class thread_pool {
 public:
  ...
  explicit thread_pool(int nThreads, int queueSize = _ctplThreadPoolLength_)
    : q(queueSize) {
    this->init();
  ...
  void clear_queue() {
    ...
    while (this->q.try_dequeue(_f)) delete _f;  // empty the queue
  }
 ...
 private:
  ...
  void set_thread(int i) {
    ...
    auto f = [this, i, flag /* a copy of the shared ptr to the flag */]() {
      proteus::setThreadName("ctplPool");
