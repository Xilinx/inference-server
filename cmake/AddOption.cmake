...
macro(add_option_env option_name description default)
  if(DEFINED ENV{AMDINFER_${option_name}})
    add_option(${option_name} ${description} $ENV{AMDINFER_${option_name}})
  else()
    add_option(${option_name} ${description} ${default})
  endif()
endmacro()
