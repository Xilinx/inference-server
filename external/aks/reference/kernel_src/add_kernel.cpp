...
int AddKernelBase::getNumCUs(void) { return 1; }

int AddKernelBase::exec_async(vector<vart::TensorBuffer*>& in,
  ...
  out.push_back(
    new AKS::AksTensorBuffer(xir::Tensor::clone(in[0]->get_tensor())));
